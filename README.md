...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/libiconv-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/libiconv-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add iconv libiconv
# for installing globally
pixi global install iconv libiconv
```
...
It is possible to list all of the versions of `iconv` available on your platform:
...
```
pixi search iconv --channel conda-forge
```
